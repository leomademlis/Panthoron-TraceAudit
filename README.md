...
1. Download the `Panthoron_TraceAudit_Agent.ipynb` file from this repository.
...
To run the Gemini 2.5 Flash model, you need an API key from Google AI Studio.
...
### Step 4: Execute the Agent
    ...
    The script will initialize the Panthoron TraceAudit Agent persona and pass the simulated crisis prompt.

    Scroll down to see the Agent autonomously invoking its three tools (calculate_quarantine_window, search_boxes_in_google_sheets, scan_google_drive_for_shipping).
