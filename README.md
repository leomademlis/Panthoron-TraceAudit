...
**Within seconds**, it synthesizes this data into an official, actionable Urgent Recall Report. The agent does not invent data; every figure comes from a tool call and can be traced back to its source.
